...
public class Znaki {
    ...
    static void izpisi16bit(short kodaZnaka) {
        for (int i = 3; i >= 0; i--) {
            for (int j = 3; j >= 0; j--) {
                ...
                System.out.print((kodaZnaka & maska) == maska ? crnaPika : belaPika);
            }
            System.out.println();
        }
    }
    ...
    static void izpisi16bit(short[] nizZnakov) {
        for (int i = 3; i >= 0; i--) {
            for (int k = 0; k < nizZnakov.length; k++) {
                for (int j = 3; j >= 0; j--) {
                    short maska = (short) (1 << 4 * i + j);
                    System.out.print((nizZnakov[k] & maska) == maska ? crnaPika : belaPika);
                }
    ...
    static int vrniIndeksZnaka(char znak) {
